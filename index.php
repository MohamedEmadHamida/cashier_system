                    ...
                    <div name="data"
                        ...
                        if ($result) {
                            ...
                            while ($res = mysqli_fetch_assoc($result)) {
                                ...
                                <a href="delete.php?id=' . $res['id'] . '&type='.$item.'" onClick="return confirm(\'Are you sure you want to delete?\')">Delete</a>
                                <a href="edit.php?id=' . $res['id'] . '&type='.$item.'">Edit</a>
                            </div>';
                            }
                        } else {
    ...
    foodOrders.forEach(function(foodOrder) {
        foodOrder.addEventListener("click", function() {
            ...
            if (existingItem) {
                ...
                newItem.innerHTML =
                    `<span>${itemName}</span> - <span class="price">${itemPrice}</span> - <span class="quantity">1</span>`;
